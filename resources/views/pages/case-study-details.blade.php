...
<html lang="zxx">
    ...
    <body>
                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse mean-menu">
                                <ul class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="case-study.html" class="nav-link active">
                                            Case Study
                                        </a>
                                        <!-- <ul class="dropdown-menu">
                                            <li class="nav-item">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="case-details-item">
                            <img src="assets/img/case-study-dateilas.jpg" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="case-details-item">
                    ...
                    <div class="col-lg-6">
                        <div class="case-details-tab-item">
                            ...
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Challenge</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Solution</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Result</a>
                                </li>
                            </ul>
                    ...
                    <div class="col-lg-6">
                        <div class="case-details-tab-item">
                            <div class="case-details-tab-img">
                                <img src="assets/img/case-study-dateilas1.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="testimonials-area case-study-area case-study ptb-100">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5 col-sm-6">
                        <div class="footer-widget">
                            ...
                            <p>This is version of Lorem Ipsum. Prwoin gravida nibh velet velit auctor aliquet. Aenean sollicit reudiqn, lorem quis thi bibendum auctor, nisi elit conseq quat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit isai amet nibh vulputate cursus a sit amet mauris. Morbi accu themsan ipsum velit Nam nec lorem ipsum tellus.</p>

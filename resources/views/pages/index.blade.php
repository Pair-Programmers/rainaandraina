                    ...
                    <div class="container">
                        <nav class="navbar navbar-expand-md navbar-light">
                            <a class="navbar-brand" href="index.html">
                                <img src="assets/img/landscape Orignal Logo@2x.png" alt="logo" style="width: 200px; height: 70px;">
                            </a>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="service-card">
                            ...
                            <div class="service-text">
                                ...
                                <p>Raina & Raina tax lawyers provide comprehensive legal advice covering all areas of tax law including planning, investigations and litigation services, anywhere in the world.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="service-card">
                            ...
                            <div class="service-text">
                                ...
                                <h3><a href="service-details.html">Sanctions and export controls</a></h3>
                                <p>International sanctions regimes are complex and often respond to volatile political landscapes. Sanctions and controls lawyers of Raina & Raina are well-positioned to help clients adapt to these fast-evolving domestic, </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="testimonials-area ptb-100">
            <div class="container">
                ...
                <div class="testimonials-slider owl-carousel owl-theme">
                        ...
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Al Moiz Industries Limited</h3>
                                    <p>Civil Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            <img src="assets/img/testimonials/testimonials2.jpg" alt="Image">
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s HILAL CHEMICALS</h3>
                                    <p>Devorce Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            <img src="assets/img/testimonials/testimonials3.jpg" alt="Image">
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Fatima Sharif Textile</h3>
                                    <p>Civil Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Orient Electronics (Pvt.) Limited</h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Crescent Cotton Mills Limited</h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Husein Sugar Mills Limited </h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Hunza Sugar Mills Limited  </h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s PAK Arab Fertilizer Limited</h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Digital World Pakistan (Pvt.) Ltd. </h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Madina Sugar Mills (Pvt.) Ltd. </h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s SHAKARGUNJ FOOD PRODUCTS LIMITED  </h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Ashraf Sugar Mills (Pvt.) Ltd.  </h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testimonials-slider-item feed-back">
                        <div class="testimonials-img">
                            ...
                            <div class="caption bottom-0">
                                <div class="caption-text">
                                    <h3>M/s Kohi Noor Industries   </h3>
                                    <p>Case</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="attorney-card">
                            ...
                            <div class="attorney-card-text">
                                <h3><a href="#">Barrister Ali Raza</a></h3>
                    ...
                    <div class="col-lg-4 col-sm-6 offset-sm-3 offset-lg-0">
                        <div class="attorney-card">
                            ...
                            <div class="attorney-card-text">
                                <h3><a href="#">Rana Zulfiqar Ali Khan</a></h3>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blog-card">
                            ...
                            <div class="blog-card-text">
                                ...
                                <p>At vero eos et accusamus et iusto odio praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate.</p>

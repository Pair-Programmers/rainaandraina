        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="{{ route('admin.gallery-folder.index') }}" class="btn btn-primary">Show List</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="POST" action="{{ route('admin.gallery-folder.update', $folder->id) }}" class="form-horizontal"

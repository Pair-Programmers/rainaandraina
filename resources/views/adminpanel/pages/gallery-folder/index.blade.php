        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="{{ route('admin.gallery-folder.create') }}" class="btn btn-primary">+ Create New</a>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        @foreach ($folders as $folder)
                                            <tr class="gradeX" id="row-{{ $folder->id }}">
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $folder->name }}</td>
                                                <td>{{ $folder->order_number }}</td>
                                                <td>{{ count($folder->galleryImagesCount) }}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <button onclick="deleteRecord({{ $folder->id }})"

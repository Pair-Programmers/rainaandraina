        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="{{ route('admin.blog-category.index') }}" class="btn btn-primary">Show List</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5>Blog <small>from here you can create your new blog category.</small></h5>
                        ...
                        <div class="ibox-content">
                            <form method="POST" action="{{ route('admin.blog-category.store') }}" class="form-horizontal"

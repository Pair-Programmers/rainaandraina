...
@section('title-meta')
    <title>{{ env('APP_NAME', 'Admin') }} | Blog List</title>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        @foreach ($galleryImages as $galleryImage)
                                            <tr class="gradeX" id="row-{{ $galleryImage->id }}">
                                                <td>{{ $loop->iteration }}</td>
                                                <td><img  src="{{asset("storage/images/gallery")}}/{{$galleryImage->image}}" width="100px" height="100px" alt=""></td>
                                                <td>{{ $galleryImage->image }}</td>
                                                <td>{{ $galleryImage->galleryFolder->name }}</td>
                                                <td>{{ $galleryImage->order_number }}</td>
                                                <td>{{ date('d-M-Y', strtotime($galleryImage->created_at)) }}</td>

                                                <td class="text-center">
                                                    <div class="btn-group">

                                                        <a href="{{ route('admin.gallery.edit', $galleryImage->id) }}"
                                                            class="btn-white btn btn-xs">Edit</a>
                                                        <button onclick="deleteRecord({{ $galleryImage->id }})"
